...
<>
    ...
    >
        ...
        <Skill name="Bash" x="-20vw" y="2vw" />
          ...
          <Skill name="Powershell" x="0vw" y="12vw" />
          <Skill name="NextJS" x="-20vw" y="-15vw" />
          <Skill name="Reverse Engineering" x="15vw" y="-12vw" />
          <Skill name="Github" x="-35vw" y="-5vw" />
          <Skill name="Web-Pentest" x="32vw" y="-5vw" />
          <Skill name="Splunk" x="0vw" y="-20vw" />
          <Skill name="Web-Design" x="-25vw" y="18vw" />
          <Skill name="Exploit-Development" x="28vw" y="18vw" />
    </div></>
  );
};
